js_f = '''function _$gK(_$nd, _$i2) {; if (_$nd["startsWith"]) return _$nd["startsWith"](_$i2); return _$nd["substr"](0, _$i2["length"]) === _$i2; }
...
js_exec = js_f + '''
var _$xS, // _$t3(); 变种的base64里面的64个字符数组
    _$wl, // _$t3(); document对象
    _$b1, // _$t3(); location
    _$jM = null, // _$t3(); null 不是 undefined
    _$zZ, // _$t3(); $_ts 对象
    _$zE = [], //_$t7();
    _$y2,
    _$ya,
